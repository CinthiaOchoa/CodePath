...
const gameText = numUnfundedGames === 1 ? "game remains" : "games remain";
const unfundedDescription = `Currently, there ${
  numUnfundedGames === 1 ? "is" : "are"
} <strong>${numUnfundedGames}</strong> ${gameText} unfunded. We need your help to fund these amazing games!`;
